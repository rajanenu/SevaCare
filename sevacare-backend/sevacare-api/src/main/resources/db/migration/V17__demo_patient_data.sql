-- =============================================================
-- V17: Seed demo data into the actual active tenant schema
--      (tenant_t_1013 = T-1013 "Lakshmi Kishore").
--      Adds blood_group column, enriches patient P-1016,
--      seeds 4 more doctors, today's appointments, past history,
--      and a prescription — all for Live Queue / Health Card demos.
-- =============================================================
